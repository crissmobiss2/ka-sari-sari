              ...
              >
                ...
                <div className="text-right shrink-0">
                  ...
                  <div className={cn(
                    ...
                    stop.paymentMethod === "cod" ? "text-warning-600" : "text-info-600 dark:text-foreground"
                  )}>
                ...
                <div className="border-t border-border bg-surface-50/50 dark:bg-surface-900/50 px-4 py-4 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                      ...
                      <p className={cn("font-bold mt-0.5", stop.paymentMethod === "cod" ? "text-warning-600" : "text-info-600 dark:text-foreground")}>
                  ...
                  {isFailed && (
                    <div className="flex items-center gap-2 text-sm text-danger-600 dark:text-danger-500 font-medium">
