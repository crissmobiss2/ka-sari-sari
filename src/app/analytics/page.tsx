...
function StatCard({
  ...
  return (
    <div className="rounded-2xl border border-border bg-card shadow-card px-4 py-4">
      ...
      <p className={cn("font-display text-xl font-black leading-tight", accent ? "text-success-700 dark:text-success-500" : "text-foreground")}>
        {value}
      </p>
      {sub && (
        <p className={cn("text-xs mt-1 flex items-center gap-1", accent ? "text-success-700 dark:text-success-500" : "text-muted-foreground")}>
          ...
          <div className="space-y-3">
            ...
            <div className="mt-3 rounded-xl bg-success-50 dark:bg-success-500/10 border border-success-200 px-4 py-3 flex items-center justify-between">
              <div>
                ...
                <p className="text-[11px] text-success-700 dark:text-success-500 mt-0.5">Buying through Ka Sari-Sari</p>
              </div>
              <div className="text-right">
                <p className="font-display text-lg font-black text-success-700 dark:text-foreground">{formatPHP(stats.savings)}</p>
                <p className="text-xs text-success-700 dark:text-success-500 font-semibold">{stats.savingsPct}% saved</p>
              </div>
            </div>
          </div>
        </div>
