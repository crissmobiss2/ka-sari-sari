  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-4 py-5 space-y-5">
        {/* Balance card */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-700 to-brand-800 p-6 text-white shadow-brand">
            ...
            <div>
              ...
              <button
                ...
                className={cn(
                  ...
                  isCustomAmount
                    ? "border-brand-500 bg-brand-50 dark:bg-brand-500/10 text-brand-700 dark:text-foreground"
