      ...
      <div className="px-4 py-5 space-y-5">
        ...
        <div className="rounded-2xl border border-border bg-card shadow-card p-5">
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-100 dark:bg-brand-700 text-brand-600 dark:text-white text-2xl font-black shrink-0">
              {userInfo.initial}
            </div>
            <div>
        ...
        <div className="rounded-2xl border border-border bg-card shadow-card p-5">
          ...
          <div className="mt-2.5">
            ...
            <div className="h-1.5 rounded-full bg-success-100 overflow-hidden">
              <div className="h-full rounded-full bg-brand-500 transition-all" style={{ width: `${creditData.utilization}%` }} />
            </div>
          </div>
              ...
              <div className="flex items-center justify-between rounded-xl bg-surface-50 dark:bg-surface-900 border border-border px-4 py-3">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isPushEnabled ? "bg-brand-500" : "bg-surface-300"
                  )}
              ...
              <div className="space-y-1.5">
                {[
                  ...
                  <div key={item} className="flex items-center gap-2">
                    <div className={cn("h-1.5 w-1.5 rounded-full shrink-0", isPushEnabled ? "bg-success-500" : "bg-surface-300")} />
