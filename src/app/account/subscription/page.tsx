        ...
        {loading ? (
          ...
          <div className={`rounded-2xl border p-6 space-y-4 ${isActive ? "border-success-500/25 bg-success-50 dark:bg-success-500/10" : "border-border bg-card"}`}>
            <div className="flex items-center gap-3">
              <div className={`flex h-12 w-12 items-center justify-center rounded-2xl ${isActive ? "bg-success-100 text-success-700 dark:text-success-500" : "bg-surface-100 dark:bg-surface-800 text-muted-foreground"}`}>
            ...
            {sub && (
              <div className="grid grid-cols-2 gap-3">
                <div className={`rounded-xl p-3 ${isActive ? "bg-white/60" : "bg-surface-50 dark:bg-surface-900"}`}>
                  <p className={`text-xs mb-0.5 ${isActive ? "text-success-700 dark:text-foreground" : "text-muted-foreground"}`}>Plan</p>
                ...
                <div className={`rounded-xl p-3 ${isActive ? "bg-white/60" : "bg-surface-50 dark:bg-surface-900"}`}>
                  <p className={`text-xs mb-0.5 ${isActive ? "text-success-700 dark:text-foreground" : "text-muted-foreground"}`}>Amount paid</p>
                ...
                <div className={`rounded-xl p-3 ${isActive ? "bg-white/60" : "bg-surface-50 dark:bg-surface-900"}`}>
                  <p className={`text-xs mb-0.5 ${isActive ? "text-success-700 dark:text-foreground" : "text-muted-foreground"}`}>Renews on</p>
                  <p className={`text-sm font-bold ${isActive ? "text-success-700 dark:text-foreground" : "text-surface-900"}`}>{sub.renewalDate}</p>
                </div>
                <div className={`rounded-xl p-3 ${isActive ? "bg-white/60" : "bg-surface-50 dark:bg-surface-900"}`}>
                  <p className={`text-xs mb-0.5 ${isActive ? "text-success-700 dark:text-foreground" : "text-muted-foreground"}`}>Days remaining</p>
