...
const PROTECTED: { pattern: RegExp; roles: Role[] | null }[] = [
  ...
  { pattern: /^\/pos/,       roles: ["retailer"] },
  { pattern: /^\/tracking/,  roles: ["retailer"] },
  { pattern: /^\/deals/,     roles: ["retailer"] },
  { pattern: /^\/reorder/,   roles: ["retailer"] },
  { pattern: /^\/loyalty/,   roles: ["retailer"] },
  { pattern: /^\/chat/,      roles: ["retailer"] },
