    ...
    <div className="fixed bottom-16 left-0 right-0 z-40 px-3">
      <div className="bg-card shadow-lg rounded-lg border-l-4 border-brand-500 px-4 py-3 flex items-center gap-3">
        ...
        <button
          ...
          className="flex-shrink-0 flex h-11 w-11 items-center justify-center rounded-xl text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-700 transition-colors"
        >
