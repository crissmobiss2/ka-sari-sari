      ...
      <div className="p-3 flex flex-col gap-2">
        ...
        {outOfStock ? (
          ...
          <button
            ...
            className="mt-1 w-full flex items-center justify-center gap-1.5 rounded-xl bg-brand-700 text-white text-xs font-semibold py-3 min-h-[44px] hover:bg-brand-800 active:scale-95 transition-all shadow-brand"
          >
