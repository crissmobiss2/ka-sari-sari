      ...
      <div className="shrink-0 px-4 py-4 bg-zinc-900 border-t border-white/10">
        ...
        <div className="flex gap-2">
          <input
            ...
            spellCheck={false}
            className="flex-1 rounded-xl bg-white/10 border border-white/20 text-white placeholder:text-white/30 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
          />
          <button
